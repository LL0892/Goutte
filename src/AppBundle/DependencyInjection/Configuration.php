                ...
                ->arrayNode('sites')
                    ->prototype('array')
                        ->children()
                            ...
                            ->end()
                            ->scalarNode('parseUrl')
                                ->info('This is the url used by the parser to get the data.')
                            ->end()
                            ->scalarNode('baseUrl')
                            ...
                            ->end()
                            ->scalarNode('inputKey')
                                ->info('This is input name where the datas are sent to in order to submit the query.')
                            ->end()
                            ...
                            ->booleanNode('titleStandardNode')
                                ->defaultTrue()
                                ->info('if standard: fetch the innerHTML content, if false: use alternative "attribute"')
                            ->end()
