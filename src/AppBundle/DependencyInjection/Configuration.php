                ...
                ->arrayNode('sites')
                    ->prototype('array')
                        ->children()
                            ...
                            ->end()
                            ->booleanNode('isFinished')
                                ->defaultFalse()
                                ->info('Define if the site is ready to parse.')
                            ->end()
                            ->scalarNode('logo')
                                ->info('This is the loogo of the site we want to parse.')
                            ->end()
                            ->arrayNode('language')
                                ->prototype('scalar')
                                    ->info('This is the list of language supported on this site.')
                                ->end()
                            ->end()
                            ->booleanNode('EAN')
                                ->defaultFalse()
                                ->info('Define if the site can support EAN-based search queries.')
                            ->end()
                            ->enumNode('searchType')
